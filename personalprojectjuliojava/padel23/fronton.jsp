<%-- 
    Document   : fronton
    Created on : 23-may-2014, 12:56:23
    Author     : Pruebas
--%>
...
<link rel="stylesheet" type="text/css" href="css/estilosfronton.css">
<!DOCTYPE html>
<html>
    <head>
    ...
    %>
       ...
       <div id="logo">
        ...
        <h5 style="color:white">Fecha de alquiler: <input type="text" name="datepicker" id="datepicker" value="<% out.print(fechaccion);%>" readonly="readonly" onchange="funcion1()"size="9" style="font-size:20;"/> <span style="color:red">Pulse para cambiar la fecha</span></h5>
        ...
        <%  ResultSet resultado37 = reservas.pistanombre("FRONTON");
        ...
        %>
         ...
         <img id="fotofronton1" src="images/polideportivo_fronton.jpg"/>
         <img id="fotofronton2" src="images/polideportivo_fronton2.jpg"/>
