<%-- 
    Document   : futbol
    Created on : 23-may-2014, 20:46:51
    Author     : Julio Jose
--%>
...
<link rel="stylesheet" type="text/css" href="css/estilosfutbol.css">
<!DOCTYPE html>
<html>
    <head>
    ...
    %>
       ...
       <div id="logo">
        ...
        <h5 style="color:white">Fecha de alquiler: <input type="text" name="datepicker" id="datepicker" value="<% out.print(fechaccion);%>" readonly="readonly" onchange="funcion5()"size="9" style="font-size:20;"/> <span style="color:red">Pulse para cambiar la fecha</span></h5>
       <%
        ...
        <ul>
         ...
         <h5><span style="color:red">Para reservar el campo de fútbol entero, pulse sobre las dos tablas a la misma hora</span></h5>   
    
    
        <%  ResultSet resultado37 = reservas.pistanombre("FUTBOL-7");
   ...
   <image id="foto1" src="images/polideportivo_futbol.JPG"/>
