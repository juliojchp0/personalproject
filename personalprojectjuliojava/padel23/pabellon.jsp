<%-- 
    Document   : pabellon
    Created on : 23-may-2014, 20:50:23
    Author     : Julio Jose
--%>
...
<link rel="stylesheet" type="text/css" href="css/estilospabellon.css">
<!DOCTYPE html>
<html>
    <head>
    ...
    %>
       ...
       <div id="logo">
        ...
        <h5 style="color:white">Fecha de alquiler: <input type="text" name="datepicker" id="datepicker" value="<% out.print(fechaccion);%>" readonly="readonly" onchange="funcion6()"size="9" style="font-size:20;"/> <span style="color:red">Pulse para cambiar la fecha</span></h5>
        <%
        ...
        <%  ResultSet resultado37 = reservas.pistanombre("PABELLON");
   ...
   <image id="fotopabellon" src="images/pabellon.JPG"/>
   <image id="fotopabellon2" src="images/Pabellon_3.JPG"/>
