...
<link rel="stylesheet" type="text/css" href="css/estilospadel.css">
<!DOCTYPE html>
<html>
    <head>
    ...
    %>
       ...
       <div id="logo">
        ...
        <h5 style="color:white">Fecha de alquiler: <input type="text" name="datepicker" id="datepicker" value="<% out.print(fechaccion);%>" readonly="readonly" onchange="funcion2()" size="9" style="font-size:20;"/><span style="color:red"> Pulse para cambiar la fecha</span></h5>
        <%
        ...
        <%  ResultSet resultado37 = reservas.pistanombre("PADEL");
   ...
   <image id="fotopadel1" src="images/polideportivo_padel.JPG"/>
   <image id="fotopadel2" src="images/polideportivo_padel2.jpg"/>
