<%-- 
    Document   : tenis
    Created on : 23-may-2014, 20:35:43
    Author     : Julio Jose
--%>
...
<link rel="stylesheet" type="text/css" href="css/estilostenis.css">
<!DOCTYPE html>
<html>
    <head>
    ...
    %>
       ...
       <div id="logo">
        ...
        <h5 style="color:white">Fecha de alquiler: <input type="text" name="datepicker" id="datepicker" value="<% out.print(fechaccion);%>" readonly="readonly" onchange="funcion3()"size="9" style="font-size:20;"/> <span style="color:red">Pulse para cambiar la fecha</span></h5>
        <%
        ...
        <%  ResultSet resultado37 = reservas.pistanombre("TENIS");
        ...
        %>
            ...
            <tr>
                <td colspan="2"><h2>Pista <%=numeropista%>: <%=nombrepista%></h2></td>
            </tr>
            <tr>
                <td>Hora</td>
                <td>Estado</td>
   ...
   <img id="fototenis" src="images/polideportivo_tenis.jpg"/>
